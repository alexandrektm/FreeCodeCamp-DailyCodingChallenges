...
def sock_pairs(pairs, cycles):
    ...
    total_socks -= (cycles // 2) + (cycles // 5)
    total_socks += (cycles // 3) + (2 * (cycles // 10))
...
# I DON'T THINK THIS^ SHOULD WORK, BUT IT SEEMS LIKE IT DOES FOR FREECODECAMP, BY ACCIDENT.
# IT DOES NOT FULLY ACCOUNT FOR THE FACT THAT YOU CAN'T LOSE SOCKS YOU DON'T HAVE. LINE 19-20 IS BAD LOGIC.
# HERE IS SOMETHING A LITTLE BETTER, THOUGH SLOWER:
